...
RSpec.describe 'the ADMIN application show' do
  it 'approve pet for adoption' do
    ...
    pet_1 = Pet.create!(name: 'Sakic', breed: 'Groenendael', age: 1, adoptable: true, shelter_id: shelter.id)
    pet_2 = Pet.create!(name: 'Onyx', breed: 'Standard Poodle', age: 4, adoptable: true, shelter_id: shelter.id)
